...
public class LocalImageUILFragment extends Fragment{
    View view;
    MyAdapter adapter;
    private int width;
    GridView gridView;
    ...
    public static LocalImageUILFragment newInstance() {
        LocalImageUILFragment fragment = new LocalImageUILFragment();
        return fragment;
    }

    public LocalImageUILFragment() {
